...
<div class="sub-content">
      ...
      <p class="onlinetit">나의 예약현황
			</p>
         <ul class="tab">
            <li class="current" data-tab="tab1"><a href="#tab1">개인 예약 현황</a></li>
            <li data-tab="tab2"><a href="#tab2">그룹 예약 현황</a></li>
         </ul>
         <div id="tab1" class="tabcontent current">
			<div class="resev-box">
				<p class="listnum">총 <span>${ list.size() }</span>건 ${currentPage }/${totalPage }&nbsp;&nbsp;&nbsp;&nbsp; <input type="button" onclick="location.href='<%=request.getContextPath() %>'" value="개인 예약 현황"> 
            &nbsp;&nbsp; <input type="button" onclick="location.href='<%=request.getContextPath() %>'" value="그룹 예약 현황"> </p>
			</div>
			<div class="onlinetb">
