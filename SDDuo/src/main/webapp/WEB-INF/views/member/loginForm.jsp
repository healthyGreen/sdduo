...
<div class="sub-content">
				<div class="sub-content-inbox">
					...
					<div class="login-title">
						<p style="width: 960px;    margin: 0 auto;">회원님의 아이디와 비밀번호를 입력하신 후 로그인 버튼을 클릭하세요! <br>아이디저장에 체크를 하시면 다음에 로그인 하실 경우 새롭게 아이디를 입력하실 필요가 없습니다.</p>
					</div>
					<div class="login-inbox2">
						...
						<input type="hidden" id="returnUrl" name="returnUrl" value="/tmweb/main.do">
							<div class="login-box login-box2 clear">
								<div class="input-id-box input-id-box2">						
									<table>
										<tbody><tr>
											<td><input type="text" placeholder="아이디" name="m_id" id="userId" value="" onkeydown="javascript:if(event.keyCode == 13) goLoginAction();" style="padding-left: 10px;"></td>
										</tr>
										<tr>
											<td><input type="password" placeholder="비밀번호를 입력해주세요." name="m_pass" id="password" value="" onkeydown="javascript:if(event.keyCode == 13) goLoginAction();" style="padding-left: 10px;"></td>
										</tr>
									</tbody></table>
								</div>							
						...
						<div class="login-btn-box">
							...
							<ul>
								<li><a href="#"><input type="button" value="신규 회원가입" class="new-join-btn" name="" style="border: none;"onclick="location.href='http://localhost:8080/SDDuo/member/agree.do'"></a></li>
							</ul>
						</div>
					</div>
				</div>
