...
${consultingmodel.c_content }
			...
			<%-- 	</c:if> --%>
						...
						<div class="area">
							...
							<p class="btn02"><input type="button" value="삭제" onclick="location.href='<%=request.getContextPath() %>/consulting/consultingDelete.do?c_number=${consultingmodel.c_number }'"></p>
						</div>
					</div>
				</div>
			</div>
