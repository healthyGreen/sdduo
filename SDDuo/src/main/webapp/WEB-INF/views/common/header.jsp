			...
			<div class="header">
				...
				<div class="header-inbox">
					<div class="header-top">
						...
						<ul class="right-area">
							<c:choose>
								<c:when test="${sessionScope.session_admin == 0}"> 
									<li>${sessionScope.session_member_name}님 환영합니다!
									<li><a href="myInfoView.do" >마이페이지</a>
									<li><a href="logout.do" >로그아웃</a>
								</c:when>
								<c:when test="${sessionScope.session_admin == 1}"> 
									<li>${sessionScope.session_member_name}님 환영합니다!
									<li><a href="adminOneReserList.do" >관리자페이지</a>
									<li><a href="logout.do" >로그아웃</a>
								</c:when>
								<c:otherwise>
						   ...
						   <ul class="gnb clear">
							  ...
							  <li class="li02"><a href="oneReserForm.do">상담예약</a>
								 <div class="subWrap sub02">
									<ul>
									    <li><a href="reservation/oneReserForm.do">개인예약</a></li>
									    <li><a href="reservation/groupReserForm.do">그룹예약</a></li>
									    <li><a href="reservation/oneReserList.do">예약현황</a></li>
					
									</ul>
								 </div>
							  </li>
							  <li class="li03"><a href="consulting/consultingList.do">온라인상담</a></li>
