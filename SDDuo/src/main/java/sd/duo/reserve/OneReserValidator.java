...
public class OneReserValidator implements Validator{
   ...
   public void validate(Object target, Errors error) {
	  ...
	  /* OneReserModel oneReserModel = (OneReserModel)target;*/
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(error, "pr_phone1", "pr_phone");
		ValidationUtils.rejectIfEmptyOrWhitespace(error, "pr_phone2", "pr_phone");
		ValidationUtils.rejectIfEmptyOrWhitespace(error, "pr_phone3", "pr_phone");
